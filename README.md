# Ali Business Logistics Tracking API For Java
Ali Business Logistics Tracking API and webhook make it easy to integrate Ali Business Logistics Tracking function into your own project. Support APIs Client Libraries for java

### API key

In order to use this API, you need to generate a Ali Business Logistics Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Ali Business Logistics Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Ali Business Logistics Tracking API](https://www.trackingmore.com/al8856-tracking.html)  to:

   *   Get Ali Business Logistics realtime tracking info of muti-carriers in one integration
   *   Provide Ali Business Logistics shipment tracking experience like Amazon
   *   Push Ali Business Logistics notifications of package update with webhook
   *   Verify Ali Business Logistics delivery exception before it is too late
